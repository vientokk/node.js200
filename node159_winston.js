...
// const appRoot = require('app-root-path'); //app root 경로 
// const moment = require('process');
...
//     return `${timestamp} [${label}] ${level}: ${message}`;  //로그 포맷 
// });
...
//     ),
//     transports: [
//         new winstonDaily({  //info 레벨 로그 저장할 파일
//             level: 'info',
//             datePattern: 'YYYY-MM-DD',
//             dirname: logDir,
//             filename: `%DATE%.log`,
//             maxFiles: 30,    //최근 30일 파일만 저장
//             zippedArchive: true
//         }),
//         new winstonDaily({
//             level: 'error',
